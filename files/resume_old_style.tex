...
% as the top. (e.g., "\begin{figure*}[!b]" is not normally possible in
	...
	\usepackage{prettyref,enumerate,etaremune}
	\usepackage{enumitem}
	...
	% beautiful system of 2 alternatives preceded by {
		...
		\begin{document}
			...
			\noindent  \Huge{Soham Jana} \hfill \LARGE{Curriculum Vitae} \\
			\vspace{1ex} 
			%	\hrule 
			\normalsize
			...
			\begin{itemize}
				\item[] Theoretical and methodological aspects of high-dimensional statistics, neural networks, mixture modeling, distance based estimators.
			\end{itemize}
			...
			\subsection*{Preprints {\normalfont (``$\ast$": Authors list not in alphabetical order)}} 
			
			\begin{enumerate}
				 
				\item Xing, H.$^\dagger$, Jana, S.$^\dagger$, \& Maleki, A.* (2025). \href{https://arxiv.org/abs/2508.18503}{\bf Minimax Analysis of Estimation Problems in Coherent Imaging}. arXiv preprint arXiv:2508.18503. $^\dagger$ Equal contributions.
				...
				\item Chen, X.$^\dagger$, Jana, S.$^\dagger$, Metzler, C.A., Maleki, A. \& Jalali, S.* (2025). \href{https://arxiv.org/abs/2505.23594}{\bf Multilook Coherent Imaging: Theoretical Guarantees and Algorithms}. arXiv preprint arXiv:2505.23594. $^\dagger$ Equal contributions.
			...
			\begin{enumerate}
				...
				\item Jana, S., Yang, K., \& Kulkarni, S. (2026).* \href{https://arxiv.org/abs/2306.09977}{\bf Adversarially robust clustering with optimality guarantees} in IEEE Transactions on Information Theory, vol. 72, no. 1, pp. 478-500, Jan. 2026, doi: 10.1109/TIT.2025.3628160.
			...
			%	\begin{itemize}
				...
				%	\end{itemize}
			%	
			\subsection*{Conferences, workshops and invited talks}
			\begin{enumerate}
				
				\item Statistical Learning and Data Science: Inference and Intelligence
				\hfill November 2026\\
				New York, USA
				
				
				\item World Meeting of the International Society for Bayesian Analysis
				\hfill June 2026\\
				Nagoya, JPN
				
				\item IMSI Workshop on Reinforcement Learning
				\hfill April 2026\\
				from Offline Data and Human Feedback\\
				Chicago, USA
			...
			\begin{itemize}
				...
				{Introduction to probability} (ACMS 30530) \hfill Fall 2024, 2025, Spring 2026
				
				{Machine Learning Methods for High-dimensional Data} (ACMS 70100) \hfill Spring 2026
...
%			\subsection*{Graduate teaching assistant} (at Yale University)
%			\begin{itemize}
...
%			\end{itemize}	
			...
			\begin{itemize}
				...
				Journal of the Royal Statistical Society (2) \\
				...
				{\it Promoting STEM education among school children} \hfill Fall 2025
				
				
				\item[] {\bf Yale S\&DS M.A. admission committee} \hfill 2021\\
