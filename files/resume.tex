...
% as the top. (e.g., "\begin{figure*}[!b]" is not normally possible in
	...
	% beautiful system of 2 alternatives preceded by {
		...
		\begin{document}
			...
			\begin{enumerate}
				\item Soham Jana, Jianqing Fan, and Sanjeev Kulkarni. {\bf \href{https://ieeexplore.ieee.org/document/11069307}{A provable initialization and robust clustering method for general mixture models}}. IEEE Transactions on Information Theory (2025). DOI: 10.1109/TIT.2025.3585804
...
%			\end{itemize}	
			...
			\begin{itemize}
				...
				(For being among top 75 in the country in INMO)
			\end{itemize}
