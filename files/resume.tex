...
% as the top. (e.g., "\begin{figure*}[!b]" is not normally possible in
	...
	% beautiful system of 2 alternatives preceded by {
		...
		\begin{document}
			...
			\begin{itemize}
				\item[] Theoretical and methodological aspects of high-dimensional statistics, robust estimation, Markov decision process, non-parametric estimation.
			\end{itemize}
			...
			\begin{itemize}
				...
				Assistant Professor, Department of Applied and \hfill Starting August 2024\\
				Computational Mathematics and Statistics.
				
				\item[] {\bf Department of Operations Research and Financial Engineering, Princeton University, Princeton, NJ, USA}
				
				Postdoc  \hfill June 2022 -- July 2024\\
			...
			\noindent \textbf{Talks}
			\begin{itemize}
				\item[] Neural information processing systems (NeurIPS) \hfill Dec 2021
				\item[] Conference on learning theory (COLT) \hfill July 2020, July 2023
			\end{itemize}
			
			
			\noindent{\bf Teaching}
			\begin{itemize}
				\item[] {Probability and stochastic systems} (ORF 309/ENG 309/MAT 380) \hfill Spring 2023\\
				%Princeton University
				
				\item[] {Statistical Machine Learning} (ORF 570)  \hfill Fall 2023\\
				%Princeton University\\
			\end{itemize}
