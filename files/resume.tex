	...
	% beautiful system of 2 alternatives preceded by {
		...
		\begin{document}
			...
			\begin{itemize}
				...
				Advisors: Prof. Sanjeev Kulkarni and Prof. Jianqing Fan  
				
				\item[] {\bf The First Republic Bank Research and Lifelong Learning Program} \hfill 2022--2023\\
				Princeton University, Princeton, New Jersey, USA\\
				Advisors: Prof. Sanjeev Kulkarni, Prof. Ronnie Sircar, and Prof. Mete Soner\\
				Research area: Capital call line of credit, resource planning
				
				\item[] {\bf Lecturer} \hfill Spring 2023--current \\
				Princeton University, Princeton, New Jersey, USA
			...
			\begin{enumerate}
				...
				\item Soham Jana, Kun Yang, and Sanjeev Kulkarni*. \href{https://arxiv.org/abs/2306.09977}{\bf Adversarially robust clustering with optimality guarantees}. arXiv preprint arXiv:2306.09977 (2023). (Submitted to the Journal of the American Statistical Association)
				
				\item Soham Jana, Yury Polyanskiy, and Yihong Wu. \href{https://arxiv.org/abs/2209.01328}{\bf Optimal empirical Bayes estimation for the Poisson model via minimum-distance methods}. arXiv preprint arXiv:2209.01328 (2022). To be submitted to Information and Inference: A Journal of the IMA.
			...
			\noindent{\bf Teaching} (at Princeton University)
			\begin{itemize}
				\item[] {\bf Probability and stochastic systems} \hfill Spring 2023\\
				ORF 309/ENG 309/MAT 380 \hfill 
				%Princeton University
				
				\item[] {\bf Statistical Machine Learning}  \hfill Fall 2023\\
				ORF 570
				(Assistant Instructor under Prof. Jianqing Fan) \hfill 
				%Princeton University\\
			\end{itemize}
			...
			\begin{itemize}
				\item[]
				{\bf Paper reviewer}\\
				IEEE Transactions on Information Theory, Stat - an ISI Journal
