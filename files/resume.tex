	...
	% beautiful system of 2 alternatives preceded by {
		...
		\begin{document}
			...
			\begin{enumerate}
				...
				\item Jana, S., Polyanskiy, Y., \& Wu, Y. (2022). \href{https://arxiv.org/abs/2209.01328}{\bf Optimal empirical Bayes estimation for the Poisson model via minimum-distance methods} arXiv preprint arXiv:2209.01328. Accepted at Information and Inference - a journal of IMA.
